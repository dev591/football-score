...
// GSAP registration is handled globally in SmoothScroll component
  ...
  return (
    <div className="bg-background selection:bg-primary-container selection:text-white overflow-x-hidden">
      ...
      <main className="pt-[72px] pb-20">
        ...
        {/* Championship Stakes (Prize Pool) - RE-DESIGNED */}
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
            <nav className="flex gap-6">
              <Link className="text-[10px] font-bold text-on-surface hover:text-primary-container tracking-widest transition-colors" href="#">RULES</Link>
              <Link className="text-[10px] font-bold text-on-surface hover:text-primary-container tracking-widest transition-colors" href="#">PARTNERS</Link>
              <Link className="text-[10px] font-bold text-on-surface hover:text-primary-container tracking-widest transition-colors" href="#">PRIVACY</Link>
            </nav>
            <div className="flex gap-4">
              <span className="material-symbols-outlined text-secondary hover:text-white cursor-pointer">share</span>
              <span className="material-symbols-outlined text-secondary hover:text-white cursor-pointer">mail</span>
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-outline-variant/5 text-center md:text-left">
          <span className="text-[10px] text-neutral-600 font-bold tracking-widest">© 2025 STRIKER COLLEGIATE BATTLEGROUND. ALL RIGHTS RESERVED.</span>
        </div>
      </footer>

      {/* BottomNavBar */}
      <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center pb-safe bg-[#131313] md:hidden z-50 border-t border-[#c7c6c6]/15 h-20">
        <Link className="flex flex-col items-center justify-center text-[#E62127] bg-gradient-to-tr from-[#1c1b1b] to-[#2a2a2a] p-2 flex-1 h-full" href="/watch?tab=live">
          <span className="material-symbols-outlined mb-1">sensors</span>
          <span className="font-body text-[10px] font-bold uppercase tracking-[0.05em]">LIVE</span>
        </Link>
        <Link className="flex flex-col items-center justify-center text-neutral-500 p-2 flex-1 h-full hover:text-white transition-all" href="/watch?tab=schedule">
          <span className="material-symbols-outlined mb-1">sports_football</span>
          <span className="font-body text-[10px] font-bold uppercase tracking-[0.05em]">GAMES</span>
        </Link>
        <Link className="flex flex-col items-center justify-center text-neutral-500 p-2 flex-1 h-full hover:text-white transition-all" href="/watch?tab=leaderboard">
          <span className="material-symbols-outlined mb-1">leaderboard</span>
          <span className="font-body text-[10px] font-bold uppercase tracking-[0.05em]">STANDINGS</span>
        </Link>
        <Link className="flex flex-col items-center justify-center text-neutral-500 p-2 flex-1 h-full hover:text-white transition-all" href="/players">
          <span className="material-symbols-outlined mb-1">person_search</span>
          <span className="font-body text-[10px] font-bold uppercase tracking-[0.05em]">RECRUITS</span>
        </Link>
        <Link className="flex flex-col items-center justify-center text-neutral-500 p-2 flex-1 h-full hover:text-white transition-all" href="/controller">
